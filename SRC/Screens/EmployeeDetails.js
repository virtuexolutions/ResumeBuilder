        ...
        <ImageBackground source={require('../Assets/Images/drawer_image2.png')} style={styles.container}>
            ...
            <ScrollView style={{ width: windowWidth, height: windowHeight * 0.99 }}>
                <View style={styles.main_view}>
                    ...
                    <CustomText isBold style={styles.sub_heading}>Employee Details</CustomText>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Contact number : </CustomText>
                        <CustomText>{data?.employee_phone_number}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Email Address : </CustomText>
                        <CustomText>{data?.employee_email}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>full Name : </CustomText>
                        <CustomText>{data?.full_name}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Designation : </CustomText>
                        <CustomText>{data?.designation}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Joining Date : </CustomText>
                        <CustomText>{data?.joining_date}</CustomText>
                    </View>
                    <CustomText isBold style={styles.sub_heading}>Deparment Details</CustomText>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Deparment Name : </CustomText>
                        <CustomText>{data?.department?.department_name}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Deparment Type : </CustomText>
                        <CustomText>{data?.department?.department_type}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Lead Full Name : </CustomText>
                        <CustomText>{data?.department?.lead_full_name}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Lead Email Address : </CustomText>
                        <CustomText>{data?.department?.lead_email_address}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Lead Contact Number : </CustomText>
                        <CustomText>{data?.department?.lead_contact_number}</CustomText>
                    </View>
                    <View style={styles.row_view}>
                        <CustomText isBold style={styles.view_heading}>Number of Employee : </CustomText>
                        <CustomText>{data?.department?.number_of_employees_in_depart}</CustomText>
                    </View>
                    <CustomText isBold style={styles.sub_heading}>Skills</CustomText>
                    <FlatList
                        data={skillsArray}
                        ListEmptyComponent={<CustomText style={{ fontSize: moderateScale(11, 0.6), color: Color.red, textAlign: 'center', marginTop: moderateScale(10, 0.6) }}>no skills added yet</CustomText>}
