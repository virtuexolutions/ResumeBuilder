                    ...
                    <View style={styles.header_view}>
                        ...
                        <View style={styles.header_subview}>
                            <View style={styles.profile_view}>
                                <CustomImage source={{ uri: `${imageUrl}${userData?.company_detail?.company_logo}` }} style={styles.image_style} />
                            </View>
                            <TouchableOpacity onPress={() => navigationService.navigate('CompanyDetails')} style={{
                                position: 'absolute',
                                top: 0,
                                ...
                                <Icon name='edit' as={Feather} size={moderateScale(18, 0.3)}
                                    color={Color.white} />
                            </TouchableOpacity>
                        ...
                        <View style={[styles.main_view, { marginTop: moderateScale(10, 0.6) }]}>
                            ...
                            <View style={styles.line} />
                            <CustomText isBold style={styles.heading}>Number of Employees</CustomText>
                            <View style={[styles.row_view, {
                                marginTop: moderateScale(10, 0.6)
                            }]}>
                                <View style={styles.detail_icon}>
                                    <Icon name='team' as={AntDesign} size={moderateScale(25, 0.3)}
                                        color={Color.white} />
                                </View>
                                <View style={{
                                    marginLeft: moderateScale(10, 0.6)
                                    ...
                                    <CustomText style={[styles.text, {
                                        textTransform: 'lowercase'
                                    }]}>{userData?.company_detail?.number_of_employees + ' Employees'}</CustomText>
                                </View>
                            </View>
                            <View style={styles.line} />
                            <CustomText isBold style={styles.heading}>Industry</CustomText>
                            <View style={[styles.row_view, {
                                marginTop: moderateScale(10, 0.6)
                            }]}>
                                <View style={styles.detail_icon}>
                                ...
                                <View style={{
                                    ...
                                    <CustomText style={styles.des}>
                                        {userData?.company_detail?.industry}
                                    </CustomText>
                                </View>
                            </View>
                        </View>
